                    ...
                    <div class="page-title-box">
                        <div class="float-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('general.attributes.add-tag') }}</li>
                            </ol>
                        </div>
                        <div class="col-md-12">
                            ...
                            <h4 class="page-title">{{ __('general.attributes.add-tag') }}</h4>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body content-area">
                            ...
                            <form action="{{ route('tags.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="name_ar"
                                        class="form-label">{{ __('general.attributes.tag_name_arabic') }}</label>
