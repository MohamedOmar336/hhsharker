                    ...
                    <div class="page-title-box">
                        <div class="float-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ url('/tasks') }}">{{ __('general.attributes.tasks') }}</a></li>
                                <li class="breadcrumb-item active">{{ __('general.attributes.edit_task') }}</li>
                            </ol>
                        </div>
                        <div class="col-md-12">
                            <a href="{{ URL::previous() }}">
                            ...
                            <h4 class="page-title">{{ __('general.attributes.edit_task') }}</h4>
                        </div>
                            ...
                            <form action="{{ route('tasks.update', $task->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="status" name="status" class="form-control @error('status') is-invalid @enderror">
                                        ...
                                        <option value="archived" {{ $task->status == 'archived' ? 'selected' : '' }}>
