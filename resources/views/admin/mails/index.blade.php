                            ...
                            {{-- <div class="email-rightbar"> --}}
                                <div class="btn-toolbar" role="toolbar">
                                    <div class="btn-group">
                                        ...
                                        <button type="button" class="btn btn-sm btn-de-secondary"
                                            onclick="submitBulkAction('move_trash')"><i
                                                class="fas fa-trash"></i>{{ __('general.btn.move_trash') }}</button>
                                    </div>
                                    ...
                                    <div class="btn-group ms-1">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="#"
                                                onclick="submitBulkAction('mark_starred')">{{ __('general.btn.mark_starred') }}</a>
                                            <a class="dropdown-item" href="#"
                                                onclick="submitBulkAction('mark_important')">{{ __('general.btn.mark_important') }}</a>
                                            <a class="dropdown-item" href="#"
                                                onclick="submitBulkAction('mark_draft')">{{ __('general.btn.mark_draft') }}</a>
                                        </div>
                                    </div>
                                </div><!-- end toolbar -->
                                    ...
                                    <div class="card my-3">
                                        <ul class="message-list">
                                                ...
                                                <li>
                                                    <div class="col-mail col-mail-1">
                                                        ...
                                                        <div class="checkbox-wrapper-mail">
                                                            <input type="checkbox" name="selected_mails[]"
                                                                value="{{ $record->id }}" id="chk{{ $record->id }}">
                                                    ...
                                                    <div class="col-mail col-mail-2">
                                                        ...
                                                        <a href="{{ route('mails.show', $record->id) }}"
                                                            class="subject">{{ $record->subject }} &nbsp;–&nbsp; <span
                                                                class="teaser">{{ nl2br($record->body) }}</span></a>
                                                        <!-- Date received -->
                                            ...
                                            @empty
                                                <li>
                                                    <div class="col-12">
                                                        <p class="text-center">{{ __('general.placeholders.no_emails') }}
                                                        </p>
                                                    </div>
                                                </li>
                                            @endforelse
                                ...
                                <div class="row mb-3">
                                    <div class="col-7 align-self-center">
                                        Showing {{ $records->firstItem() }} - {{ $records->lastItem() }} of
                                        {{ $records->total() }}
                                    </div>
                                    <div class="col-5">
