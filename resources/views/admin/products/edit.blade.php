                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane active" id="step4">
                                    <div class="card-body">
                                        <form action="{{ route('products.update', $product->id) }}" method="post" id="custom-step" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <nav>
                                            ...
                                            <div class="tab-content" id="product-nav-tabContent">
                                                <div class="tab-pane fade show active" id="step1" role="tabpanel" aria-labelledby="step1-tab">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="product_name_ar" type="text" class="form-control @error('product_name_ar') is-invalid @enderror" name="product_name_ar" value="{{ old('product_name_ar', $product->product_name_ar) }}">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="product_name_en" type="text" class="form-control @error('product_name_en') is-invalid @enderror" name="product_name_en" value="{{ old('product_name_en', $product->product_name_en) }}">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="product_description_ar" class="form-control @error('product_description_ar') is-invalid @enderror" name="product_description_ar">{{ old('product_description_ar', $product->product_description_ar) }}</textarea>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="product_description_en" class="form-control @error('product_description_en') is-invalid @enderror" name="product_description_en">{{ old('product_description_en', $product->product_description_en) }}</textarea>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select id="category_id" class="form-control @error('category_id') is-invalid @enderror" name="category_id" value="{{ old('category_id', $product->category_id) }}">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="status" type="text" class="form-control @error('status') is-invalid @enderror" name="status" value="{{ old('status', $product->status) }}">
                                                        @error('status')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                ...
                                                <div class="tab-pane fade" id="step2" role="tabpanel" aria-labelledby="step2-tab">
                                                    ...
                                                    <div class="mb-3 AirConditioner">
                                                        ...
                                                        <input id="hp_dimensions_volume_en" type="text" class="form-control @error('hp_dimensions_volume_en') is-invalid @enderror" name="hp_dimensions_volume_en" value="{{ old('hp_dimensions_volume_en', $product->hp_dimensions_volume_en) }}">
                                                    ...
                                                    <div class="mb-3 AirConditioner">
                                                        ...
                                                        <input id="hp_dimensions_volume_ar" type="text" class="form-control @error('hp_dimensions_volume_ar') is-invalid @enderror" name="hp_dimensions_volume_ar" value="{{ old('hp_dimensions_volume_ar', $product->hp_dimensions_volume_ar) }}">
                                                    ...
                                                    <div class="mb-3 HomeAppliances">
                                                        ...
                                                        <input id="optional_features_ar" type="text" class="form-control @error('optional_features_ar') is-invalid @enderror" name="optional_features_ar" value="{{ old('optional_features_ar', $product->optional_features_ar) }}">
                                                    ...
                                                    <div class="mb-3 HomeAppliances">
                                                        ...
                                                        <input id="optional_features_en" type="text" class="form-control @error('optional_features_en') is-invalid @enderror" name="optional_features_en" value="{{ old('optional_features_en', $product->optional_features_en) }}">
                                                    ...
                                                    <div class="mb-3 AirConditioner">
                                                        ...
                                                        <input id="color" type="text" class="form-control @error('color') is-invalid @enderror" name="color" value="{{ old('color', $product->color) }}">
                                                        @error('color')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="best_selling" id="best_selling" {{ $product->best_selling ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="recommended" id="recommended" {{ $product->recommended ? 'checked' : '' }}>
                                                ...
                                                <div class="tab-pane fade" id="step3" role="tabpanel" aria-labelledby="step3-tab">
                                                    ...
                                                    <div class="mb-3 HomeAppliances">
                                                        ...
                                                        <input id="type_freon" type="text" class="form-control @error('type_freon') is-invalid @enderror" name="type_freon" value="{{ old('type_freon', $product->type_freon) }}">
                                                        @error('type_freon')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="technical_specifications" type="text" class="form-control @error('technical_specifications') is-invalid @enderror" name="technical_specifications" value="{{ old('technical_specifications', $product->technical_specifications) }}">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="saso_certificate" class="form-label">SASO Certificate:</label>
                                                        <textarea id="saso_certificate" class="form-control @error('saso_certificate') is-invalid @enderror" name="saso_certificate">{{ old('saso_certificate', $product->saso_certificate) }}</textarea>
