      ...
      <x-table tableId="DataTables">
        ...
        @foreach ($records as $record)
          <tr>
            ...
            <td>
              <a href="{{ route('ticket_histories.show_by_ticket', $record->id) }}" class="btn btn-sm btn-info">{{ __('general.actions.history') }}</a>
              <a href="{{ route('tickets.edit', $record->id) }}" class="btn btn-sm btn-primary">{{ __('general.actions.edit') }}</a>
