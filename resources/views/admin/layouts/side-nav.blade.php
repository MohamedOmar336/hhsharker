                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse " id="sidebarHospital">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a href="#sidebarAppointments " class="nav-link"
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse" id="sidebarPatients">
                                            <ul class="nav flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a class='nav-link'
                                                        href='hospital-patient-profile.html'>Patient Profile</a>
                                                </li><!--end nav-item-->
                                            </ul><!--end nav-->
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse" id="sidebarPayments">
                                            <ul class="nav flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a class='nav-link'
                                                        href='hospital-payment-invoice.html'>Payment Invoice</a>
                                                </li><!--end nav-item-->
                                                <li class="nav-item">
                                                    <a class='nav-link'
                                                        href='hospital-cashless-payments.html'>Cashless
                                                        Payments</a>
                                                </li><!--end nav-item-->
                                            </ul><!--end nav-->
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse" id="sidebarStaff">
                                            <ul class="nav flex-column">
                                                <li class="nav-item">
                                                    <a class='nav-link' href='hospital-all-staff.html'>All
                                                        Staff</a>
                                                </li><!--end nav-item-->
                                                <li class="nav-item">
                                                ...
                                                <li class="nav-item">
                                                    <a class='nav-link' href='hospital-salary.html'>Staff
                                                        Salary</a>
                                                </li><!--end nav-item-->
                                            </ul><!--end nav-->
