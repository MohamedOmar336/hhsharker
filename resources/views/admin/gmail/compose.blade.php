                ...
                <div class="col-12 col-lg-12 mx-auto">
                    <div class="card">
                        <div class="card-body content-area">
                            ...
                            <form action="{{ route('gmail.send') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                                @csrf
                                <div class="mb-3">
                                    <label for="recipient_email" class="form-label">{{ __('general.attributes.recipient') }}</label>
