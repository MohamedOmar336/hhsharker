        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="float-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('general.attributes.add-role') }}</li>
                            </ol>
                        </div>
                         <div class="col-md-12">
                            <a href="{{ URL::previous() }}">
                   ...
                   <h4 class="page-title">{{ __('general.attributes.add-role') }}</h4>
                </div>
                ...
                <div class="col-12 col-lg-11 mx-auto">
                    <div class="card">
                         <div class="card-body content-area">
                            ...
                            <form id="quickForm" method="POST" action="{{ route('roles.store') }}" enctype="multipart/form-data"
                                ...
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <select id="choices-multiple-remove-button" class="form-control"
                                            placeholder="Choose ..." multiple name="permissions[]">
                                            @foreach ($acls as $acl)
                                                <option value="{{ $acl['route'] }}">{{ $acl['key'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
