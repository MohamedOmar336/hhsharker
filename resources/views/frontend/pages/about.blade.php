        ...
        <div class="container">
            ...
            <div class="about-nub-div wow fadeIn" data-wow-duration="2s" style="background-image: url(images/about-nub-bg.png);">
                <div class="m-auto wow fadeInRightBig" data-wow-delay="0.4s">
                    <div class="ani-nub-banner"><span class="numberanimation">{{ __('website.about.middle_section.box_1_desc') }}</span>%</div>
                ...
                <div class="m-auto wow fadeInRightBig" data-wow-delay="0.6s">
                    <div class="ani-nub-banner"><span class="numberanimation">{{ __('website.about.middle_section.box_2_desc') }}</span>{{ __('website.about.middle_section.box_2_desc_3') }}<span class="ani-nub-small">{{ __('website.about.middle_section.box_2_desc_2') }}</span></div>
                ...
                <div class="m-auto wow fadeInRightBig" data-wow-delay="0.8s">
                    <div class="ani-nub-banner">{{ __('website.about.middle_section.box_3_desc') }}. <span class="numberanimation">{{ __('website.about.middle_section.box_3_desc_2') }}</span></div>
