...
class CheckPermissions
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        if ($userPermissions && $currentRouteName != 'home' && $currentRouteName != 'chat.index' && $currentRouteName != 'chat.checkRoom' && $currentRouteName != 'chat.create' && $currentRouteName != 'tickets.my') {
