var options = {
    ...
    chart = new ApexCharts(document.querySelector("#Tickets_Status"), options),
    dash_spark_1 =
        (chart.render(),
        {
            ...
            series: [
                {
                    data: [
                        4, 8, 5, 10, 4, 16, 5, 11, 6, 11, 30, 10, 13, 4, 6, 3,
                        6,
                    ],
                },
            ],
    ...
    dash_spark_2 =
        ...
        ).render(),
        {
            ...
            series: [
                {
                    data: [
                        4, 8, 5, 10, 4, 25, 5, 11, 6, 11, 5, 10, 3, 14, 6, 8, 6,
                    ],
                },
            ],
            yaxis: { min: 0 },
    ...
    options =
        (new ApexCharts(
            document.querySelector("#dash_spark_2"),
            dash_spark_2
        ).render(),
        {
