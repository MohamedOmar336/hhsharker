...
var options2 = {
    ...
    options =
        ((chart = new ApexCharts(
            document.querySelector("#treemap_1"),
            options
        )).render(),
        {
            series: [
    ...
    options =
        ((chart = new ApexCharts(
            document.querySelector("#treemap_2"),
            options
        )).render(),
        {
    ...
    options =
        ((chart = new ApexCharts(
            document.querySelector("#polar_Area_1"),
            options
        )).render(),
        {
    ...
    options =
        ((chart = new ApexCharts(
            document.querySelector("#polar_Area_2"),
            options
        )).render(),
        {
    ...
    spark1 = {
        ...
        fill: { opacity: 0.2 },
        series: [
            { name: "Metrica Sales ", data: randomizeArray(sparklineData) },
        ],
        yaxis: { min: 0 },
        colors: ["#f93b7a"],
        title: {
    ...
    spark3 =
        (new ApexCharts(document.querySelector("#spark2"), spark2).render(),
        {
            ...
            fill: { opacity: 0.2 },
            series: [
                { name: "Net Profits ", data: randomizeArray(sparklineData) },
            ],
